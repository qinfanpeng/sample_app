...
describe "UserPages" do
  ...
  before(:all) { 30.times { FactoryGirl.create(:user) } }  # 为后面 分页准备的测试数据
  ...
  describe "signup page" do
    ...
    describe "signup" do
      ...
      describe "with valid information" do
        before do
          fill_in "Name",         with: "Exemple User"
  ...
  describe "profile page" do
    ...
    let!(:m1) { FactoryGirl.create(:micropost, user: user, content: "Foo") } # let! 立即执行，而 let 懒惰执行
    ...
    describe "follow/unfollow buttons" do
      ...
      describe "following a user" do
        ...
        describe "toggling the button 'Follow' to 'Unfollow'" do
      ...
      describe "unfollowing a user" do
        ...
        describe "toggling the button 'Unfollow' to 'Follow'" do
